...
public class HashMapExplained {
	...
	public static void main(String args[]){
		...
		Map<String,Student> namesMap = new HashMap<String,Student>();
		namesMap.put("IraqBoy",new Student("Sinan","Web Technologies"));
		//namesMap.put("KenyaBoy", "Duncan");
		//namesMap.put("BanglaBoys", "Abdullah/Imran");
		
		
		
		System.out.println(namesMap.get("IraqBoy").getSpecialization());
		System.out.println(namesMap.get("IraqBoy").getName());
